...
public:
	...
	vSeeds.push_back(CDNSSeedData("151.80.76.2", "151.80.76.2"));
	//vSeeds.push_back(CDNSSeedData("s2.coso.live", "s2.coso.live"));
	//vSeeds.push_back(CDNSSeedData("s3.coso.live", "s3.coso.live"));
