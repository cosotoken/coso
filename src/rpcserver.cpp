        ...
        try {
            ...
            if (strCommand == "") {
                ...
                if (category != pcmd->category) {
                    ...
                    string firstLcoso = category.substr(0, 1);
                    boost::to_upper(firstLcoso);
                    strRet += "== " + firstLcoso + category.substr(1) + " ==\n";
                }
            }
            strRet += strHelp + "\n";
        }
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* COSO features */
        {"coso", "masternode", &masternode, true, true, false},
        {"coso", "masternodelist", &masternodelist, true, true, false},
        {"coso", "mnbudget", &mnbudget, true, true, false},
        {"coso", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"coso", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"coso", "mnsync", &mnsync, true, true, false},
        {"coso", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cosod, or the -server option to coso-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> coso-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:40012/\n";
}
