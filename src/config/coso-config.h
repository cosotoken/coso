/* src/config/coso-config.h.  Generated from coso-config.h.in by configure.  */
/* src/config/coso-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef COSO_CONFIG_H

#define COSO_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.cosos"

/* Define to the full name of this package. */
#define PACKAGE_NAME "COSO Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "COSO Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coso"
