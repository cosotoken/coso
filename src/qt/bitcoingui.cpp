                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("COSO-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a COSO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coso: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About COSO Core"), this);
    aboutAction->setStatusTip(tr("Show information about COSO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for COSO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your COSO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified COSO addresses"));
    ...
    openAction->setStatusTip(tr("Open a COSO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the COSO Core help message to get a list with possible COSO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("COSO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to COSO network", "", count));
}
...
{
    QString strTitle = tr("COSO Core"); // default title
