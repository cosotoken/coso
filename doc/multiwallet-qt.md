...
In order to support loading of multiple wallets in coso-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is coso.cpp.
...
Changes to coso.cpp
----------------------
coso.cpp is the entry point into coso-qt, and as such, will require some minor modifications to provide hooks for
