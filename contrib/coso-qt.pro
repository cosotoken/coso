...
RESOURCES += src/qt/coso.qrc src/qt/coso_locale.qrc

TRANSLATIONS += src/qt/locale/coso_bg.ts \
                src/qt/locale/coso_de.ts \
                src/qt/locale/coso_en.ts \
                src/qt/locale/coso_es.ts \
                src/qt/locale/coso_fi.ts \
                src/qt/locale/coso_fr.ts \
                src/qt/locale/coso_it.ts \
                src/qt/locale/coso_ja.ts \
                src/qt/locale/coso_pl.ts \
                src/qt/locale/coso_pt.ts \
                src/qt/locale/coso_ru.ts \
                src/qt/locale/coso_sk.ts \
                src/qt/locale/coso_sv.ts \
                src/qt/locale/coso_vi.ts \
                src/qt/locale/coso_zh_CN.ts \
                src/qt/locale/coso_zh_TW.ts
