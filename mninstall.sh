...
COINDOWNLOADLINK1=https://github.com/cosoteam/coso/releases/download/v1.0/cosod
COINDOWNLOADLINK2=https://github.com/cosoteam/coso/releases/download/v1.0/coso-cli
COINDOWNLOADLINK3=https://github.com/cosoteam/coso/releases/download/v1.0/coso-tx
COINPORT=40011
COINRPCPORT=40012
COINDAEMON=cosod
COINDAEMONCLI=coso-cli
COINDAEMONTX=coso-tx
COINCORE=.coso
COINCONFIG=coso.conf
